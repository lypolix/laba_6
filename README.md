...
научиться находить проблемы качества (code smells) в реальном коде, выполнять рефакторинг маленькими шагами, применять DRY/KISS на практике и сохранять поведение программы при изменении структуры (все тесты должны продолжать проходить).
